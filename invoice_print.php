            ...
            <div class="client-section">
                <div class="bill-to">
                    ...
                    <?php if (!empty($invoice['bill_company']) || !empty($invoice['company'])): ?>
                        <div style="color: #666; margin-bottom: 10px;"><?= htmlspecialchars($invoice['bill_company'] ?? $invoice['company']) ?></div>
                    <?php endif; ?>
                    <div style="font-size: 14px; line-height: 1.4; color: #555;"><?= nl2br(htmlspecialchars($invoice['bill_address'] ?? $invoice['address'] ?? '')) ?></div>
                </div>
                ...
                <div class="ship-to">
                    ...
                    <?php if (!empty($invoice['ship_company']) || !empty($invoice['bill_company']) || !empty($invoice['company'])): ?>
                        <div style="color: #666; margin-bottom: 10px;"><?= htmlspecialchars($invoice['ship_company'] ?? $invoice['bill_company'] ?? $invoice['company']) ?></div>
                    <?php endif; ?>
                    <div style="font-size: 14px; line-height: 1.4; color: #555;"><?= nl2br(htmlspecialchars($invoice['ship_address'] ?? $invoice['bill_address'] ?? $invoice['address'] ?? '')) ?></div>
                </div>
            </div>
