                                        ...
                                        <?php foreach ($items as $item): ?>
                                            <tr class="product-row">
                                                <td>
                                                    ...
                                                    <select name="items[product_description][]" class="form-control product-select" required onchange="updatePrice(this)">
                                                        <option value="">Select Product</option>
                                                        <?php foreach ($products as $product): ?>
                                                            <option value="<?= htmlspecialchars($product['product_name']) ?>" 
                                                                    data-price="<?= $product['price'] ?>"
                                                                    <?= ($item['product_description'] === $product['product_name'] ? 'selected' : '') ?>>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" 
                                                               ...
                                                               step="0.01" 
                                                               min="0" 
                                                               value="<?= htmlspecialchars(number_format((float)($item['tax_discount_value'] ?? 0), 2, '.', '')) ?>">
                                    ...
                                    <?php else: ?>
                                        <tr class="product-row">
                                            ...
                                            <td>
                                                ...
                                                <div class="input-group">
                                                    <input type="number" name="items[tax_discount_value][]" class="form-control tax-discount-value" step="0.01" min="0" placeholder="0.00" value="0">
                                                    <span class="input-group-text">%</span>
                                                </div>
                                            </td>
                                            <td>
    ...
    const newRow = `
        <tr class="product-row">
            ...
            <td>
                ...
                <input type="number" name="items[quantity][]" class="form-control quantity" step="1" min="0" placeholder="0" value="1" required>
            </td>
            <td>
                <div class="input-group">
                    <span class="input-group-text currency-symbol">INR</span>
                    <input type="number" name="items[unit_price][]" class="form-control unit-price" step="0.01" min="0" placeholder="0.00" value="0" required>
                </div>
            </td>
            <td>
                <select name="items[tax_discount_type][]" class="form-control mb-1 tax-discount-type">
...
function updatePrice(selectElement) {
    ...
    if (price) {
        row.find('input[name="items[unit_price][]"]').val(parseFloat(price).toFixed(2));
